...
# Map our internal field keys to the variants we accept in the sheet's header
# row. Match is case-insensitive and tolerant of parenthesized hints
# (e.g. "Generated by (Sagar/Cowork)" -> "generated by").
